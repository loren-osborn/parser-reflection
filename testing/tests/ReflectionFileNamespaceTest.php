...
use Go\ParserReflection\TestingSupport\Stubs\TestNamespaceClassFoo;
...
class ReflectionFileNamespaceTest extends TestCaseBase
{
    ...
    public function testGetConstant()
    {
        ...
        $this->assertEquals(\Go\ParserReflection\TestingSupport\Stubs\NAMESPACE_NAME, $constValue);
    }
    ...
    public function testGetEndLine()
    {
        ...
        $this->assertEquals(\Go\ParserReflection\TestingSupport\Stubs\END_MARKER + 1, $endLine);
    }

    public function testGetFileName()
    {
        $fileName = $this->parsedRefFileNamespace->getFileName();
        $this->assertEquals(\Go\ParserReflection\TestingSupport\Stubs\FILE_NAME, $fileName);
    }
    ...
    public function testGetName()
    {
        ...
        $this->assertEquals(\Go\ParserReflection\TestingSupport\Stubs\NAMESPACE_NAME, $namespaceName);
    }
    ...
    public function testGetStartLine()
    {
        ...
        $this->assertEquals(\Go\ParserReflection\TestingSupport\Stubs\START_MARKER - 2, $startLine);
    }
