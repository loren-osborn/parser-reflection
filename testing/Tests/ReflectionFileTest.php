...
class ReflectionFileTest extends TestCaseBase
{
    ...
    {
        $reflectionFileNamespace = $this->parsedRefFile->getFileNamespace('Go\ParserReflection\Testing\Support\Stub');
    ...
    {
        $hasFileNamespace = $this->parsedRefFile->hasFileNamespace('Go\ParserReflection\Testing\Support\Stub');
