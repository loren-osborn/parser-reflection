...
class ReflectionParameterTest extends TestCaseBase
{
    ...
    {
        $parsedNamespace = $this->parsedRefFile->getFileNamespace('Go\ParserReflection\Testing\Support\Stub');
    ...
    public function testParamWithDefaultConstValue()
    {
        ...
        $this->assertSame('Go\ParserReflection\Testing\Support\Stub\TEST_PARAMETER', $parameters[2]->getDefaultValueConstantName());

        $this->assertTrue($parameters[3]->isDefaultValueConstant());
        $this->assertSame('Go\ParserReflection\Testing\Support\Stub\SubFoo::ANOTHER_CLASS_CONST', $parameters[3]->getDefaultValueConstantName());
    }
    ...
    public function testDebugInfoMethod()
    {
        ...
        $originalRefParameter = new \ReflectionParameter('Go\ParserReflection\Testing\Support\Stub\miscParameters', 'arrayParam');
